      ...
      >
        ...
        <div style={{ position: 'relative', overflow: 'hidden', background: '#0f3aad', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          {nota.foto_url
            ...
            : <img src={cat.img} alt={cat.sub} style={{ width: '95%', opacity: 0.9, filter: 'drop-shadow(0 4px 16px rgba(0,0,0,0.3))', mixBlendMode: 'multiply' }} />
          }
        </div>
      </div>
    )
    ...
    >
      <div style={{ height: 140, background: cat.color, position: 'relative', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        {nota.foto_url
          ...
          : <img src={cat.img} alt={cat.sub} style={{ width: '95%', opacity: 0.92, filter: 'drop-shadow(0 2px 8px rgba(0,0,0,0.25))', mixBlendMode: 'multiply', position: 'relative', zIndex: 1 }} />
        }
