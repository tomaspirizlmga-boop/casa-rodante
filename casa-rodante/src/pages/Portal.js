    ...
    <div>
      <div style={{ background: 'var(--azul)', padding: '60px 28px 90px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', maxWidth: 560, margin: '0 auto' }}>
          ...
          {/* Furgoneta */}
          <img src="/ilustraciones/casa-rodante.png" alt="Casa Rodante" style={{ width: 380, margin: '0 0 20px -60px', filter: 'drop-shadow(0 4px 20px rgba(0,0,0,0.35))' }} />
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 36 }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 20 }}>
              <img src="/ilustraciones/casa-rodante.png" alt="Casa Rodante" style={{ width: 160, filter: 'brightness(0.9)' }} />
              <div>
